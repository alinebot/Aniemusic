...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("DenvilMusic=▶️ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("DenvilMusic=⏸ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("DenvilMusic=⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("DenvilMusic=⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("DenvilMusic=❇️ Admin cache refreshed!")
